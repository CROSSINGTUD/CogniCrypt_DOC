...
<div class="frontpage">
    <div class="section">
        <h1>Cryptographic API Documentation generated by CogniCrypt<sub>DOC</sub></h1>
        <p>This documentation was created by CogniCrypt<sub>DOC</sub> based on CrySL rules and complements the official <a target="_blank" rel="noopener noreferrer"
