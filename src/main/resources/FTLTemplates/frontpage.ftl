...
<div class="frontpage">
    <div class="section">
        <h1>Cryptographic API Documentation generated by CrySL<sub>DOC</sub></h1>
        <p>This documentation was created by CrySL<sub>DOC</sub> based on CrySL rules and complements the official <a target="_blank" rel="noopener noreferrer"
                                                                                                                           href="https://docs.oracle.com/javase/8/docs/api/java/security/package-summary.html">JavaDoc</a>.</p>
        <h2>First Steps</h2>
        <p>Are you new to documentation generated by CrySL<sub>DOC</sub>? Read the following instructions to get
            started!</p>
        <p>Click on the left to read the documentation for a single class.</p>
        <p>Read <a href="crysl.html">How CrySL works</a> first to understand CrySL.</p>
    ...
    <div class="section">
        ...
        <ul>
            ...
            <li><a target="_blank" rel="noopener noreferrer"
                   href="https://github.com/CROSSINGTUD/CogniCrypt_TESTGEN/tree/develop">
                    Crypt<sub>TESTGEN</sub></a>: Generate
                test cases.
            </li>
        </ul>
    </div>
